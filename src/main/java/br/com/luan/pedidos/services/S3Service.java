...
public class S3Service {
    ...
    public URI uploadFile(MultipartFile multipartFile) { //MultipartFile é o tipo que o String usa para receber arquivos na requisicao
        try {
            ...
            throw new RuntimeException("Erro na criação da URI: " + e.getMessage());
        }
    }
